...
# Set MLflow tracking URI (can change this to a remote server)
...
def train():
    ...
    # Start MLflow run
    with mlflow.start_run(run_name="housing_linear_regression") as run:     # can add any number to the "run_name" for versioning
